...
| `generate.py` | Regenerate the above from [`docs/ALGORITHM.md`](../../docs/ALGORITHM.md) |

Coverage:

- In-China points (Shanghai / Beijing) and bbox corners: all six `op`s.
- Outside points (NYC, `(0,0)`, outside bbox): WGS↔GCJ and BD stages are identity (pg bbox rules).
...
1. Change formulae in [`docs/ALGORITHM.md`](../../docs/ALGORITHM.md) first, then `python3 testdata/golden/generate.py`, then `test/sql/run_sql_track.sh`.
